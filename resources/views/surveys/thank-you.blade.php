...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="card-modern text-center animate-fade-in-up">
        <div class="p-12 lg:p-16">
            ...
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">Terima Kasih!</h1>
            <p class="text-xl text-gray-600 dark:text-gray-400 mb-2">
                Survey "<strong class="text-gray-900 dark:text-white">{{ $survey->title }}</strong>" telah berhasil Anda submit.
            </p>
