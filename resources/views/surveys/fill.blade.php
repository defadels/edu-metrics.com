...
@section('content')
    <div class="bg-theme-primary text-black py-12 mb-10 shadow-inner">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-black/80">{{ $survey->title }}</p>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div class="bg-gray-100 rounded-2xl p-6 mb-10 border border-gray-200">
            <h3 class="font-bold text-gray-900 mb-2 flex items-center gap-2">
                <svg class="w-5 h-5 text-theme-active" fill="currentColor" viewBox="0 0 20 20">
            ...
            <p class="text-gray-600 text-sm leading-relaxed">
                Silakan baca setiap pernyataan dengan seksama dan berikan jawaban yang paling sesuai dengan persepsi Anda.
                Berikan tanda centang pada kolom yang tersedia untuk setiap pilihan jawaban yang tersedia.
            </p>
        </div>
...
$options = $firstLikert
    ? $firstLikert->likertScale->options->sortBy('order')
                                        : collect();
                                @endphp
                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-6">
                                        ...
                                        @if ($question->question_type === 'text')
                                            <div class="mt-4">
                                                <textarea name="answers[{{ $question->id }}][text_value]" rows="3" placeholder="Tuliskan jawaban Anda..."
