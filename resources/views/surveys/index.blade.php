...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-12 animate-fade-in-up">
        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-3">Available Surveys</h1>
        <p class="text-lg text-gray-600 dark:text-gray-400">Choose a survey you want to take</p>
    </div>
    ...
    @else
        <div class="card-modern p-16 text-center animate-fade-in-up">
            ...
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">No Surveys Available</h3>
            <p class="text-gray-500 dark:text-gray-400 text-lg mb-8">There are no surveys available at the moment.</p>
            <a href="{{ route('home') }}" 
