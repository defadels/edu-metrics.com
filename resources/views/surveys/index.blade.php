        ...
        @if ($surveys->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($surveys as $index => $survey)
                    <div
                        class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group flex flex-col">
                        <div class="mb-4">
                            <span
                                class="px-3 py-1 text-xs font-bold rounded-lg bg-gray-100 text-gray-600 uppercase tracking-wider">
