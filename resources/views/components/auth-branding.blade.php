<div
    class="flex w-full lg:w-1/2 bg-gradient-to-br from-lime-600 via-lime-700 to-lime-800 relative overflow-hidden min-h-[300px] lg:min-h-screen">
    <!-- Background Pattern -->
    ...
    <div class="relative z-10 flex flex-col justify-between h-full p-6 lg:p-12 text-white">
        ...
        <div class="flex flex-col items-center mb-8 animate-fade-in-up">
            <div
                class="w-20 h-20 lg:w-32 lg:h-32 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center mb-4 lg:mb-6 shadow-2xl p-3">
        ...
        <div class="flex-1 flex flex-col justify-center animate-fade-in-up animate-delay-100">
            ...
            <p class="hidden lg:block text-lg md:text-xl text-purple-100 leading-relaxed mb-8 max-w-md text-center">
            ...
            {{-- <a href="#"
                class="hidden lg:inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl max-w-fit">
