...
<div class="mb-6 flex justify-between items-center animate-fade-in-up">
    <div>
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Daftar Responden</h3>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Kelola data peserta kuesioner</p>
    </div>
</div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-modern">
            <thead>
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Nama Lengkap</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Email</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider text-center">Total Kuesioner Selesai</th>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            @if($respondent->responses_count > 0)
                                <span class="px-3 py-1 text-xs font-bold rounded-lg bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300">
                                    {{ $respondent->responses_count }} Kuesioner
                                </span>
                            @else
                                <span class="px-3 py-1 text-xs font-semibold rounded-lg bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400">
                                    Belum mengisi
                                </span>
                            @endif
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            ...
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">Tidak ada data responden</h3>
                            <p class="text-gray-500 dark:text-gray-400">Belum ada peserta yang terdaftar di dalam sistem.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
