    ...
    <div class="lg:col-span-1">
        <div class="card-modern h-full">
            <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
                <div class="w-24 h-24 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full flex items-center justify-center text-3xl font-bold mb-4">
            ...
            <div class="p-6">
                <h5 class="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider mb-4">Informasi Tambahan</h5>
                <dl class="space-y-4">
                    <div>
                        <dt class="text-sm text-gray-500 dark:text-gray-400">NIM / Nomor Induk</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white mt-1">{{ $respondent->nim ?? 'Tidak ada data' }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm text-gray-500 dark:text-gray-400">Tanggal Mendaftar</dt>
                        <dd class="text-sm font-semibold text-gray-900 dark:text-white mt-1">{{ $respondent->created_at->format('d M Y, H:i') }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm text-gray-500 dark:text-gray-400">Total Kuesioner Selesai</dt>
                        <dd class="mt-2">
                            <span class="px-3 py-1 text-xs font-bold rounded-lg bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300">
            ...
            <div class="p-0">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-modern">
                            <thead class="bg-gray-50 dark:bg-gray-800">
                                <tr>
                                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Judul Kuesioner</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Kategori</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Tanggal Selesai</th>
                ...
                @else
                    <div class="py-12 text-center px-6">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-sm">Responden ini belum pernah menyelesaikan kuesioner apapun.</p>
                    </div>
                @endif
            </div>
        </div>
