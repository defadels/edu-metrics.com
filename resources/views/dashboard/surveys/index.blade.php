...
<div class="mb-6 flex justify-between items-center animate-fade-in-up">
    <div>
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Daftar Survey</h3>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Kelola survey Anda</p>
    </div>
...
<div class="card-modern overflow-hidden animate-fade-in-up animate-delay-100">
    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700">
            <tr>
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Judul</th>
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Kategori</th>
                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Pertanyaan</th>
            ...
            @empty
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Tidak ada survey.</p>
                    </td>
                </tr>
            @endforelse
        </tbody>
