...
@section('content')
    <div class="space-y-6">
        ...
        <section aria-label="Metric summary" class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
            ...
            <article class="rounded-2xl border border-gray-200 border-l-4 border-l-amber-500 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-amber-700 dark:text-amber-300">Satisfied and very satisfied</p>
                    </div>
            ...
            <article class="rounded-2xl border border-gray-200 border-l-4 border-l-cyan-600 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-cyan-700 dark:text-cyan-300">Recorded in the system</p>
                    </div>
